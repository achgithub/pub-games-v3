# PubGames V3 - Static App Template

This is the standard template for creating new static (iframe-embedded) apps in the PubGames V3 ecosystem.

## Architecture

- **Backend**: Go API (Port 50X1)
- **Frontend**: React app (Port 50X0), loaded in iframe by Identity Shell
...
| `BACKEND_PORT` | 50X1 | Backend API port |
| `FRONTEND_PORT` | 50X0 | Frontend dev server port |
