#!/bin/bash
# Start core services: identity-shell, setup-admin, game-admin, tic-tac-toe, dots, last-man-standing, sweepstakes, quiz-player, quiz-master, quiz-display, mobile-test
